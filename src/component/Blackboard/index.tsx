...
const Blackboard = ({ excuse }: Props) => {
  if (!excuse) {
    return <div className='blackboard'><h5 className='blackboard__text'>Click one of the excuse buttons above to view further details of why I never finish assignments in time.</h5></div>
  }
